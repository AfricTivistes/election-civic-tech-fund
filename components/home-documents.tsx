    ...
    <section className="container mx-auto px-6 py-16">
      ...
      <div className="text-center mb-16">
        <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-white via-yellow-200 to-blue-200 bg-clip-text text-transparent">
          {language === 'en' ? 'Call for Projects Response Documents' : 'Documents de Réponse à l\'Appel à Projets'}
        </h2>
...
export default function HomeDocuments() {
  ...
  const texts = {
    fr: {
      ...
      sectionSubtitle: "Téléchargez tous les documents nécessaires pour transformer votre vision démocratique en réalité avec le Election Civic Tech Fund.",
      preview: "Aperçu",
    ...
    en: {
      ...
      sectionSubtitle: "Download all necessary documents to transform your democratic vision into reality with the Election Civic Tech Fund.",
      preview: "Preview",
      download: "Download",
  ...
  return (
    <section className="container mx-auto px-6 py-16">
          ...
          return (
            ...
            >
              ...
              <CardHeader className="pb-4 relative">
                {/* Titre du document */}
                <div className="mb-4">
                  <CardTitle className="text-white text-2xl group-hover:text-yellow-200 transition-colors mb-3 font-bold flex items-center">
                    <div className={`relative p-3 bg-gradient-to-br ${doc.color} bg-opacity-20 rounded-xl border border-white/30 shadow-lg mr-4`}>
                      <Icon className="w-6 h-6 text-white" />
                      <span className="absolute -top-1 -right-1 text-sm bg-white/20 rounded-full p-1 backdrop-blur-sm">
                        {getFileTypeIcon(doc.type)}
                      </span>
                    </div>
                ...
                <p className="text-blue-200/90 leading-relaxed ml-14 text-base">
                  {doc.description[language] || doc.description.en}
                </p>
              </CardHeader>

              <CardContent className="pt-0">
                {/* Boutons d'action */}
                <div className="flex items-center justify-end space-x-4 ml-14">
                  <Button
                    onClick={() => handleView(currentFilename)}
                    variant="ghost"
                    size="lg"
      ...
      <div className="text-center">
        <div className="inline-flex flex-col items-center space-y-4 bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl px-10 py-8 shadow-2xl max-w-4xl">
          <h3 className="text-2xl font-bold text-white mb-2">
            {currentTexts.readyTitle}
          </h3>

          <p className="text-blue-200/90 text-lg leading-relaxed mb-4">
            {currentTexts.readyText}
          </p>
