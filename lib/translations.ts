    ...
    hero: {
      ...
      footer: {
        ...
        countries: {
          ...
          subtitle: "Cliquez sur un pays pour découvrir ses défis démocratiques",
          challengesTitle: "Défis Démocratiques",
        }
      },
      guide: {
    ...
    hero: {
      ...
      footer: {
        ...
        countries: {
          ...
          subtitle: "Click on a country to find out about its democratic challenges",
          challengesTitle: "Democratic Challenges",
        }
      },
      guide: {
