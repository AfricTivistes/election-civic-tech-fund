...
export const translations: Record<string, Translation> = {
  fr: {
    ...
    winners: {
      ...
      transformMessage: "Ces 13 projets innovants vont transformer la démocratie en Afrique. Ensemble, ils représentent l'avenir de l'engagement civique numérique et contribueront à renforcer les processus démocratiques sur le continent.",
  ...
  en: {
    ...
    hero: {
      ...
      platformDescription: "This platform is designed as an interactive tool to facilitate your application. This call for proposals invites you to propose your innovative ideas through four key steps.",
      secondDescription: "Join a €200,000 community dedicated to democratic innovation in 14 African countries. Together, let's build the digital future of African democracy.",
    ...
    winners: {
      ...
      transformMessage: "These 13 innovative projects will transform democracy in Africa. Together, they represent the future of digital civic engagement and will help strengthen democratic processes across the continent.",
